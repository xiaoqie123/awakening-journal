  ...
  return (
    <div className="space-y-8 animate-pulse">
      <div className="text-center py-10">
        <div className="w-8 h-8 bg-warm-200 dark:bg-deep-700 rounded-full mx-auto mb-4" />
        <div className="h-8 w-64 bg-warm-200 dark:bg-deep-700 rounded-lg mx-auto mb-2" />
        <div className="h-4 w-48 bg-warm-200 dark:bg-deep-700 rounded mx-auto" />
      </div>
